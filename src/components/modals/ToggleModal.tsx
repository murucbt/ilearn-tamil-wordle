    ...
    <div className="card dropbottom">
      {isShowMore && (
        <div className="details">
            ...
            <p>சொல்லில் ஒரே ஒரு <b>ன்</b> இருப்பினும் இரண்டு இடங்களிலும் வண்ண குறிப்புகள் இருப்பது குழப்பமாக தோன்றினாலும் தர்க்கரீதியாக அது சரியான குறியீடே ஆகும். ஒருவேளை 2<sup>வது</sup> இடத்தில் சாம்பல் நிறம் இருந்தால் ன-கர வரிசையே அந்த இடத்தில் இல்லை என்று தவறாக பொருள்படும்.</p>
       </div>
      )}
